...
class FileScanRecordTestDao extends GenericDao<Long, FileScanRecord> {

    protected FileScanRecordTestDao() {
        this("fixity-pu");
    }

    protected FileScanRecordTestDao(final String persistenceUnitName) {
